    ...
    <div class="container">
        <form action="/cua-hang/update" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="diaChi" value="${cv.diaChi}" required><br>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Thanh pho</label>
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="thanhPho" value="${cv.thanhPho}" required><br>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Quoc gia</label>
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="quocGia" value="${cv.quocGia}" required><br>
                </div>
            </div>
